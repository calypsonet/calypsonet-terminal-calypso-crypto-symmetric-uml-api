...
[cols="^.^1h,.^5", grid=rows, frame=all]
|===
| Signature      | `setSerialNumber(serialNumber: ByteArray) -> Self`
| Since          | 0.1
...
[cols="^.^1h,.^5", grid=rows, frame=all]
|===
| Signature      | `setTerminalChallenge(terminalChallenge: ByteArray) -> Self`
| Since          | 0.1
...
[cols="^.^1h,.^5", grid=rows, frame=all]
|===
| Signature      | `setTerminalSvMac(terminalSvMac: ByteArray) -> Self`
| Since          | 0.1
...
[cols="^.^1h,.^5", grid=rows, frame=all]
|===
| Signature      | `setTransactionNumber(transactionNumber: ByteArray) -> Self`
| Since          | 0.1
