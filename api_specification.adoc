...
`{nbsp}{nbsp}{nbsp}{nbsp}cardKeyDiversifier: byte array,` +
`{nbsp}{nbsp}{nbsp}{nbsp}useExtendedMode: boolean,` +
`{nbsp}{nbsp}{nbsp}{nbsp}transactionAuditData: list<byte array>` +
...
`{nbsp}{nbsp}{nbsp}{nbsp}cardChallenge: byte array,` +
`{nbsp}{nbsp}{nbsp}{nbsp}currentPin: byte array,` +
`{nbsp}{nbsp}{nbsp}{nbsp}newPin: byte array,` +
...
`{nbsp}{nbsp}{nbsp}{nbsp}cardChallenge: byte array,` +
`{nbsp}{nbsp}{nbsp}{nbsp}pin: byte array,` +
`{nbsp}{nbsp}{nbsp}{nbsp}kif: byte,` +
`{nbsp}{nbsp}{nbsp}{nbsp}kvc: byte` +
`) -> byte array`
| Since       | 0.1
...
`{nbsp}{nbsp}{nbsp}{nbsp}openSecureSessionDataOut: byte array,` +
`{nbsp}{nbsp}{nbsp}{nbsp}kif: byte,` +
`{nbsp}{nbsp}{nbsp}{nbsp}kvc: byte` +
`) -> void`
| Since       | 0.1
